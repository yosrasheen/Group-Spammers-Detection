...
In this post you can find a simple twitter scraper in PHP, a simplified version of the one we (DMI) used for our #iranelection project. Just copy-paste the code below into a file called twitterScraper.php and follow the directions in the comments.
